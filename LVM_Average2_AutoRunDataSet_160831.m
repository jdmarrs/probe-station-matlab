...
saveas(gca,strcat(path, filex(1:length(filex)-4),'_',date,'ACDCnum_heatUnkn.fig'), 'fig');
saveas(gca,strcat(path, filex(1:length(filex)-4),'_',date,'ACDCnum_heatUnkn.png'), 'png');
%%
xcelfile=strcat(path,filex(1:sz-4),'_Means_ZeroNorms_',date,'ACDCnum_heatUnkn.xlsx');
