...
for k = 1 : length(allFiles)
    ...
    if(strfind(allFiles(k).name, '.dat'))
        ...
        V1=dat(750:1250,1); % v1
        V2=dat(750:1250,4); % v2
        V3=dat(750:1250,5); % v3
...
xcelfile=strcat(path,filex(1:sz-4),'_LinS_R-4pp.xlsx');
